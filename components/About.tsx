...
export default function About() {
  return (
        <div className=" justify-around flex mb-20">
            <div className=" flex w-[570px] justify-center">
                <Image
          src={AboutPet}
          alt="пескот"
          className=""
        />
            ...
            <div  className="flex flex-col gap-[25px] items-start">
                ...
                <p className="text-[#4C4C4C] text-start">We feed our wards with the best food and make sure that they <br /> do not get sick, feel comfortable (including psychologically) and <br /> well. We are supported by 87 volunteers and 28 employees of <br /> various skill levels. About 12% of the  animals are taken by the <br />shelter staff. Taking care of the animals, they become attached <br /> to the pets and would hardly ever leave them alone.</p>
            </div>
